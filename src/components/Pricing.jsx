                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        <div className="relative bg-gray-800 rounded-2xl p-8 shadow-xl transition-transform duration-300 hover:scale-105 border border-gray-700">
                            ...
                            <button className="w-full py-3 px-6 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium hover:opacity-90 transition-opacity">
                                Get Started Free
                            </button>
                        </div>
                        <div className="relative bg-gradient-to-b from-purple-600 to-purple-800 rounded-2xl p-8 shadow-xl transition-transform duration-300 hover:scale-105">
                            ...
                            <button className="w-full py-3 px-6 rounded-lg bg-gradient-to-r from-yellow-500 to-pink-500 text-white font-medium hover:opacity-90 transition-opacity">
                                Upgrade to Premium
                            </button>
                        </div>
                    </div>
