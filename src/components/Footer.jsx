        ...
        <footer className="bg-white dark:bg-gray-800 mt-10">
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex items-center gap-2 justify-center sm:justify-start font-bold dark:text-gray-300 text-gray-500  text-xl md:text-3xl">
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                        <div className="text-center sm:text-left">
                            <p className="text-lg font-medium dark:text-gray-300 text-gray-700">About Us</p>
                        ...
                        <div className="text-center sm:text-left">
                            <p className="text-lg font-medium dark:text-gray-300 text-gray-700">Our Services</p>
                        ...
                        <div className="text-center sm:text-left">
                            <p className="text-lg font-medium dark:text-gray-300 text-gray-700">Helpful Links</p>
                        ...
                        <div className="text-center sm:text-left">
                            <p className="text-lg font-medium dark:text-gray-300 text-gray-700">Contact Us</p>
                                ...
                                <li>
                                    ...
                                    >
                                        <svg
                                            ...
                                            className="size-5 shrink-0 dark:text-gray-300 text-gray-700"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            stroke="currentColor"
                                            strokeWidth="2"
